const customFormValidationSourceCode = `
  <form id="form-custom-validation" class="max-w-lg p-4 mx-auto bg-white border border-slate-300 shadow rounded-sm dark:bg-slate-800 dark:border-slate-600" novalidate>
    <!-- Form Body -->
