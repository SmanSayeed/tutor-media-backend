...
export class SearchModal {
  ...
  renderItem(page) {
    return `
      <li class="">
        <a href="${page.url}" class="flex rounded-sm px-4 py-2 text-sm items-center gap-2 bg-slate-50 hover:bg-slate-100 dark:bg-slate-700 dark:hover:bg-slate-600 shadow-sm">
