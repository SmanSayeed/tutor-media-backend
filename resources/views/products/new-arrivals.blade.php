<x-app-layout title="New Arrivals">
    <div class="max-w-7xl mx-auto px-4 py-8">
        <!-- Page Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">New Arrivals</h1>
            <p class="text-gray-600">Check out our latest shoe collection</p>
        </div>

        <!-- Filters and Search -->
        <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
            <form method="GET" action="{{ route('products.new-arrivals') }}" class="flex flex-col md:flex-row gap-4">
                <!-- Search -->
                <div class="flex-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
            @forelse($products as $productData)
                ...
                <div class="relative">
                    <div class="absolute top-3 left-3 bg-gradient-to-r from-green-500 to-teal-500 text-white px-2.5 py-1 text-xs font-bold rounded-lg shadow-sm z-10">
                        New
                    </div>
            ...
            @empty
                ...
                <div class="col-span-full">
                    <div class="text-center py-12">
                        <h3 class="text-lg font-semibold text-gray-600 mb-2">No New Arrivals Found</h3>
