        ...
        <form method="POST" action="{{ route('admin.authenticate') }}">
            ...
            <div class="mt-6 flex flex-col gap-5">
                ...
                <div>
                    ...
                    <input type="text" required class="input border-red-500 " name="email"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" value="12345678" required id="password"
                            class="input border-red-500 pr-10" name="password" placeholder="Password" />
