    ...
    <div class="card mx-auto w-full max-w-md p-4 xl:p-6">
        @env('local')
            <div class="flex justify-center gap-4 mb-5">
                <x-login-link class="btn btn-outline-primary" redirectUrl="/admin/dashboard" guard="admin" key="1" label="Login as Admin" />
                <x-login-link class="btn btn-outline-primary" redirectUrl="/" guard="web" key="2" label="Login as User" />
            </div>
        @endenv
        <form method="POST" action="{{ route('admin.authenticate') }}">
            ...
            <div class="mt-6 flex flex-col gap-5">
                ...
                <div>
                    ...
                    <input type="text" class="input border-red-500 " name="email" placeholder="Enter Your Email"
                        value="{{ old('email') }}" />
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" id="password" class="input border-red-500 pr-10" name="password"
            ...
            <div class="mt-2 flex items-center justify-between">
                ...
                <a href="{{ route('admin.forgot-password') }}" class="text-sm text-primary-500 hover:underline">Forgot
                    Password</a>
            </div>
            <!-- Login Button -->
            <div class="mt-8">
            ...
            <div class="mt-4 flex justify-center">
                <p class="text-sm text-slate-600 dark:text-slate-300">
                    Don't Have an Account?
                    <a href="{{ route('admin.register') }}" class="text-sm text-primary-500 hover:underline">Sign up</a>
                </p>
            </div>
        </form>
    </div>
